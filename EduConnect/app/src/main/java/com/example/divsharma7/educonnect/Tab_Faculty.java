...
public class Tab_Faculty extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View rootView = inflater.inflate(R.layout.fragment_tab__faculty, container, false);
            ...
            public boolean onChildClick(ExpandableListView parent, View v,int groupPosition, int childPosition,long id) {
                ...
                switch (cat_type){
                   ...
                   //     System.out.println(department.get(childPosition));
                        valueofcat=department.get(childPosition);

                        break;
                    case "Research Field":
                        valueofcat=research.get(childPosition);
                        break;
                ...
                intent.putExtra("mycontext","Faculty");
    ...
    public void prepareListData()
    {
        ...
        listDataHeader.add("Research Field");
        ...
        mDatabase.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                for (DataSnapshot messageSnapshot: dataSnapshot.getChildren()) {
                    ...
                    if(!research.contains(res_field))
                    {
                        research.add(res_field);
                    }
        ...
        listDataChild.put(listDataHeader.get(1), research);
